...
'''
Support for Entropy
#cloned from portage .. entropy Requires portage however is PM for Sabayon Linux and related. 
...
def __virtual__():
    '''
    Confirm this module is on a Sabayon based system
    '''
    if HAS_ENTROPY and __grains__['os'] == 'Sabayon':
